...
export const IngredientNames: Record<IngredientKey, { en: string; hy: string }> = {
  ...
  [IngredientKey.N5Spaghetti]: {en: 'N°5 Spaghetti', hy: 'թիւ 5 սպակեթթի'},
  [IngredientKey.BiftekMeat]: {en: 'biftek meat', hy: 'պիւֆդէք միս'},
  [IngredientKey.FineSemolina]: { en: 'fine semolina', hy: 'ֆըրխա' },
